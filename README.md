...
powershell -ExecutionPolicy Bypass -File .\install-car.ps1 `
  -ApkPath .\RoadAssistant-2.64-logic-audit.apk
```
...
- Малые режимы антирадара и маршрута требуют Android 8/API 26+, интернет, GPS
  и API-ключ MapKit. Маршрутный режим рисует полилинию и текущую позицию из
  `Y.nav.map`, а также манёвр и общий прогресс; после пяти минут без обновлений
